...
class WordOfTheDayModel(application: Application) {
    ...
    suspend fun getWord(category: String): Word {
        ...
        val id = responseJson.getString("results")
        //TODO following code after server done
...
//        }
        //TODO replace below
        return Word(id, locale, wotdCategory, "def", "usage", "origin", "part", "", Difficulty.OTHER, "phonetic")
    }
